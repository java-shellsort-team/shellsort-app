...
На текущем этапе команда использует **Gradle** и **JDK 21**.  
Ниже приведена инструкция для первого запуска проекта.
...
- **Git** установлен
- **Gradle устанавливать не нужно** — используется встроенный **Gradle Wrapper**
...
```bash
# Требуется установленный gradle только для генерации wrapper
gradle wrapper
...
- Канал для общения: Telegram / Yandex Telemost (ежедневные короткие синки)
